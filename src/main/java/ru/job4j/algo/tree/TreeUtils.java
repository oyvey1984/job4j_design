...
public class TreeUtils<T> {
    ...
    /**
     * Метод выполняет обход дерева в ШИРИНУ и считает количество узлов
    ...
    /**
     * Метод выполняет обход дерева в ШИРИНУ и возвращает коллекцию ключей узлов дерева
    ...
    /**
     * Метод обходит дерево root в ГЛУБИНУ и добавляет к узлу с ключом parent
    ...
    /**
     * Метод обходит дерево root в ГЛУБИНУ и возвращает первый найденный узел с ключом key
     * @param root корень дерева
