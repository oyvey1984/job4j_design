...
public class Generics {
    public static void main(String[] args) {
        ...
        first.add(new Animal("Proailurus lemanensis", false, 30));
        second.add(new Predator("Panthera palaeosinensis", false, 30));
        third.add(new Tiger("Panthera tigris", false, 30));
